...
### Your two route files

Since your actual screens are in `src/screens`, keep these very small.
...
This version already gives you the complete **frontend chat flow**:
...
There is **no AI functionality** and no fake AI responses.

The important part is that the code is structured so that later we can replace:
...
with Supabase queries and then add Supabase Realtime without redesigning your screens.

**Next step should be Supabase integration:** we'll create the `conversations`, `conversation_participants`, and `messages` tables, add RLS policies, then replace the mock data with real users and real-time messages.
