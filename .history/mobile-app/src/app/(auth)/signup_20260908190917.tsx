...
The campus list above is a **starter list**, not something we should treat as the official complete Richfield campus list. The hackathon document doesn't provide a campus list, so I don't want to invent an "official" list.

Also, visually, I would eventually turn the programme and campus sections into **proper dropdown/select components** rather than displaying every option at once.

The important validation is already in place:
...
And the **Create Account** button stays disabled until the form passes all those checks.
